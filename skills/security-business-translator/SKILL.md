...
1. Extract security findings, affected assets, exploitability, exposure, controls and remediation options.
2. Translate technical risk into business impact, customer impact, regulatory exposure, operational resilience and financial risk.
3. Prioritize remediation by business criticality, threat likelihood, dependency and feasibility.
4. Identify decisions: accept, mitigate, transfer, fund, defer or escalate.
5. Draft executive security language and funding rationale.
