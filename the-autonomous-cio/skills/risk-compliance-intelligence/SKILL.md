...
1. Extract risks, controls, obligations, evidence items, owners, due dates and affected assets or processes.
2. Categorize risks by strategic, operational, financial, compliance, security, data, vendor and architecture impact.
3. Assess likelihood, impact, velocity, detectability, control strength and confidence.
4. Identify control gaps, documentation gaps, audit readiness issues and risk dependencies.
5. Prioritize countermeasures and prepare executive escalation language.
6. Produce an evidence-package outline when audit preparation is requested.
